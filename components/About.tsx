...
export default function About() {
  ...
  return (
    <section
      ref={ref}
      id="about"
      className="mb-30 mt-30 max-w-[45rem] leading-8 sm:mb-28 sm:mt-28 scroll-mt-28"
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">software developer</span>.{" "}      </p>
        <p className="mb-3">
          ...
          finally figuring out a solution to a problem. I&apos;m always eager to <span className="underline">learn new
          technologies</span> and am currently seeking a{" "}
      ...
      <p>
        <span className="italic">{`When I'm not coding`}</span>, I teach others how to perform handstands, nurture my own practice, and savor delicious vegan food. I also enjoy{" "}
